...
class ChecklistAlertViewController: UIViewController {
    ...
    @IBAction func didTapOnCreateNewProject(_ sender: Any) {
        if #available(iOS 13.0, *) {
            let alertVC = newProjectAlertService.alert(checklist: checklistData!, simulation: mySimulationData!)
    ...
    private func saveChecklistGeneral(project: Project, checklist: ChecklistData) {

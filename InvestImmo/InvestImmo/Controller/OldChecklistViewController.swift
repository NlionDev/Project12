...
class OldChecklistViewController: UIViewController {
    ...
    let existantProjectAlert = ExistantProjectAlert()
...
//            let alertVC = newProjectAlert.alert(checklist: checklistData, simulation: simulation)
//            present(alertVC, animated: true)
//        } else {
//            let alertVC = existantProjectAlert.alert(checklist: checklistData, simulation: simulation)
//            present(alertVC, animated: true)
//        }
    }
...
//extension OldChecklistViewController: UIPickerViewDelegate, UIPickerViewDataSource {
//
